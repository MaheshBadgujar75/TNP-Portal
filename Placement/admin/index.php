    ...
    <footer id="footer" class="text-gray-600 body-font bg-gray-800 border-t-2 border-gray-700 small mb-0 ">
      ...
      <div class="pt-1 pb-2">
        <ul class="flex  space-x-16 justify-center text-white my-4 ">
          ...
          <li><a href="https://www.facebook.com/Vishwaniketan/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
          <li><a href="https://twitter.com/vishwaniketan"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
          <li><a href="https://www.instagram.com/vishwaniketan_.engineering/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
          <li><a href="https://in.linkedin.com/school/vishwaniketan-imeet/"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
